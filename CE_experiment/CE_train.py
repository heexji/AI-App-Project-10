...
class ImbalancedCIFAR10(Dataset):
    def __init__(
        ...
        cifar10 = torchvision.datasets.CIFAR10(root=root, train=train, download=download)
    ...
    def get_img_num_per_cls(self, cls_num: int) -> List[int]:
        img_max = len(self.targets) / cls_num  # 50000/10=5000
    ...
    for epoch in range(EPOCHS):
        ...
        if test_acc > best_acc:
            ...
            torch.save(
                ...
                os.path.join("model", "best_ce_cifar10_resnet32.pth"),
            )
