...
from imbalanced_bdd import IMBALANCEBDDWeather
...
parser.add_argument('--bdd_root', type=str, default=None,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'cifar100':
        num_classes = 100
    elif args.dataset == 'bdd_weather':
        num_classes = 7   # BDD100K weather 클래스 개수
    else:
        num_classes = 10  # 기본: cifar10
    ...
    # Data loading code
    if args.dataset.startswith('bdd'):
        # BDD 전용: 학습/검증 모두 32x32로 리사이즈
    ...
    if args.dataset == 'cifar10':
        ...
        base_dir = args.bdd_root  # argparse로 하나 추가해도 되고, 코드에 직접 쓸 수도 있음
        train_dataset = IMBALANCEBDDWeather(
            base_dir=base_dir,
            split='train',
        ...
        val_dataset = IMBALANCEBDDWeather(
            base_dir=base_dir,
            split='val',
            imb_type='none',      # 검증은 보통 원본 분포 그대로
            imb_factor=1.0,
